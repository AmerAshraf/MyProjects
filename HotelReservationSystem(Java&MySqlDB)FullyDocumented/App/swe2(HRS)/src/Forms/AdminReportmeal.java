 ...
 * @author ATHER
 */
public class AdminReportmeal extends javax.swing.JFrame {

    /**
     * Creates new form EmployeeReportCust
     */
    public AdminReportmeal() {
        initComponents();
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        new Manager_Tools().printReport(tblMeal, "Flights Report");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminReportmeal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
