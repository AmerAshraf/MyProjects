...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 02, 2018 at 01:05 PM
...
(4, '42543.png', 'gfkbfnbfkj', 'kjjcgkjbfkj');
...
INSERT INTO `supplier` (`subno`, `subname`, `subadd`) VALUES
(1, 'Amershop', 'october'),
(2, 'Ahmedshop', 'matarya'),
(3, 'Ashrafshop', 'seuz'),
(4, 'Heshamshop', 'cairo');
...
(1, 'img/1t.png', 'Bedtime Bliss Herbal Supplement', '6$'),
...
(8, 'teto', '12121212121212', 'customer', '0101010', 'amer-ashraf@outlook.com', 'Male'),
(10, 'Ahmed', '1234', 'customer', '010101101010', 'ahmedhesham@yahoo.com', 'Male');
...
--
ALTER TABLE `bread`
  MODIFY `breadno` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `cheese`
--
ALTER TABLE `cheese`
  MODIFY `cheeseno` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `supplier`
--
ALTER TABLE `supplier`
  MODIFY `subno` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tea`
--
ALTER TABLE `tea`
  MODIFY `teano` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
